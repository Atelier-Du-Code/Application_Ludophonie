...
namespace Application_Ludophonie.Modele
{
    ...
    {
        private static readonly string server = "srv991.hstgr.io";
        private static readonly string userid = "u607780247_testLudo";
        private static readonly string password = "gTyHI2QZez";
        private static readonly string database = "u607780247_testLudo";
        ...
        public static Utilisateur ControleIdentite(string unIdentifiant)
        {
            ...
            if (curs.Read())
            {
                ...
                DateTime dateInscription = ((DateTime)curs.Field("dateInscription"));
